...
static const _Pollu_type_support_symbol_names_t _Pollu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hanium_interface, msg, Pollu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hanium_interface, msg, Pollu)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hanium_interface, msg, Pollu)() {
  return &::hanium_interface::msg::rosidl_typesupport_c::Pollu_message_type_support_handle;
}
